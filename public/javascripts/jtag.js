//https://raw.github.com/djpate/jTag/master/source/jquery.tag.js
	...
	$.extend($.fn,{
		...
		showDrag: function(e){
			...
			var position = function(context){
				...
				left_pos = parseInt(jtagdrag.position().left) + border;
				top_pos =  parseInt(jtagdrag.position().top) + border;
			...
			$(".jTagSaveBtn",container).click(function(){
				...
				top_pos = $(this).parent().parent().position().top;
